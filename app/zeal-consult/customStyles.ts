...
import { Styles as S023 } from "@/sections/s023/v1/types";
import {
    color,
    display,
    fontFamily,
...
const useCustomStyles = () => {
    ...
    const s023: s023 = {
        ...
        logo: {
            ...
            color: colors.white,
			fontSize: "30px",
			paddingBottom: responsive("30px", "0", "0"),
        },
        imgContainer: {
			// align
			display: "flex",
			// flexDirection: "row",
			width: responsive("100%", "150px", "150px"),
